    ...
    <div class="container">
      <div class="text-center">
        ...
        <h3 class="section-subheading text-muted">
          ...
          y Gas L.P.   Construcción completa y proyecto en mano.
        </h3>
      </div>
      <ul class="timeline">
        <li>
          ...
          <div class="timeline-panel">
            ...
            <div class="timeline-body">
              <p class="text-muted">
                ...
                brindarles calidad, costo y apegados siempre a la norma (NOM).
              </p>
            </div>
          </div>
        </li>
          ...
          <div class="timeline-panel">
            ...
            <div class="timeline-body">
              <p class="text-muted">
                ...
                orientada a resultados y el uso permanente de tecnología de
                vanguardia.
              </p>
            </div>
          </div>
        ...
        <li>
          ...
          <div class="timeline-panel">
            ...
            <div class="timeline-body">
              <p class="text-muted">
                Trabajar en función de las necesidades del cliente, superando
                sus expectativas, basándonos en los principios de calidad,
                servicio, honestidad y eficiencia, todos estos bajo el concepto
